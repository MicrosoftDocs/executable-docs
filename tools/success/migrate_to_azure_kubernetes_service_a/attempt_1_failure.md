...
1. Create a resource group using the [`az group create`][az-group-create] command.
    ...
    First, export variables and add a random suffix to ensure resource names are unique.
...
2. Create an AKS cluster using the [`az aks create`][az-aks-create] command.
    ...
    Set the cluster name and create an AKS cluster with autoscaler and standard load balancer.
    ...
    ```output
    {
      ...
      "enableRBAC": true,
      "fqdn": "myaksclusterxxx-dns-xxxxxxxx.eastus.cloudapp.azure.com",
      ...
      "provisioningState": "Succeeded",
      ...
    }
