---
title: Краткое руководство. Создание виртуальной машины Red Hat Enterprise Linux с помощью Azure CLI
description: 'Из этого краткого руководства вы узнаете, как использовать Azure CLI для создания виртуальной машины Red Hat Enterprise Linux'
author: namanparikh
...
# Краткое руководство. Создание виртуальной машины Red Hat Enterprise Linux с помощью Azure CLI в Azure
