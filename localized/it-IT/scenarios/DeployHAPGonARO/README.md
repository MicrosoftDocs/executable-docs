...
1. Imposta la `STORAGE_ACCOUNT_NAME` variabile di ambiente su una concatenazione di `stor`, `LOCAL_NAME` (convertita in minuscolo) e `SUFFIX` (convertita in minuscolo).
