...
Vi måste också lagra anslutningssträng till databasen i en miljövariabel för senare användning. Med den här URL:en kan vi komma åt databasen i den resurs som vi nyss skapade.
