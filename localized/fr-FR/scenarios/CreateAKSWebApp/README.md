...
[![Déployer dans Azure](https://aka.ms/deploytoazurebutton)](https://go.microsoft.com/fwlink/?linkid=2286416)
...
Un fichier de test YML de l’application de vote est déjà préparé. 
...
Pour déployer cette application, exécutez la commande suivante
